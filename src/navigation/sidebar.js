...
import {FaRegAddressCard,FaChevronCircleLeft,FaChevronCircleRight, FaCalendarCheck,FaClipboardCheck} from 'react-icons/fa'
    ...
    <div className='main-container'>
        <motion.div animate={{width:isOpen ? '20%':'4.5%'}} className='sidebar'>
            <div className='topSection'>
                ...
                {isOpen ? <div id ='arrow' className='toggleSideBar'><FaChevronCircleLeft onClick={toggle}/></div>:<div id ='arrow' className='toggleSideBar'><FaChevronCircleRight  onClick={toggle}/></div>}
            </div>
